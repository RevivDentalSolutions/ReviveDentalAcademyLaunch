...
const defaults: Record<VideoLessonLayoutId, Partial<VideoLessonScene>> = {
  ...
  quiz: { title: "Pause & Practice", quizQuestion: "Which answer is correct?", quizChoices: ["Choice A", "Choice B", "Choice C"], correctAnswerIndex: 0, quizExplanation: "Explain why the answer is correct.", answerRevealInSeconds: 7, body: "Which answer is correct?", bullets: ["Choice A", "Choice B", "Choice C"], narrationScript: "Pause here and choose your answer. Then continue to see the reasoning.", durationInSeconds: 12 },
